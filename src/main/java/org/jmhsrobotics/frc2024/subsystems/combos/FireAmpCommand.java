...
public class FireAmpCommand extends ParallelCommandGroup{
    private ArmPIDSubsystem armSubsystem;
    private ShooterSubsystem shooterSubsystem;

    public FireAmpCommand(ShooterSubsystem shooterSubsystem, ArmPIDSubsystem armPIDSubsystem){
        this.armSubsystem = armSubsystem;
        this.shooterSubsystem = shooterSubsystem;

        addCommands(new ArmSetAmpCommand(this.armSubsystem), new ShooterCommand(1, this.shooterSubsystem));
