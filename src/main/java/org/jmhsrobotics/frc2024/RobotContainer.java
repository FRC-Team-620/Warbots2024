...
public class RobotContainer implements Logged {
	...
	private void configureBindings() {
		...
		this.control.intakeInput().whileTrue(new IntakeCommand(0.9, this.intakeSubsystem));
		this.control.extakeInput().whileTrue(new IntakeCommand(-0.9, this.intakeSubsystem));
